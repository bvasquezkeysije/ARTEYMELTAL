<x-app-layout>
    ...
    <div x-data="{
        ...
        initMontoRecibido() {
            if (this.formaPago !== 'efectivo' && this.formaPago !== 'mixto') this.montoRecibido = this.totalVenta;
        },
        onFotosPagoChange(e) {
                ...
                <div class="rounded-xl border border-gray-200 bg-gray-50 p-4">
                    ...
                    <div class="grid gap-3 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input id="monto_recibido" name="monto_recibido" type="number" step="0.01" x-model="montoRecibido" :readonly="formaPago !== 'efectivo' && formaPago !== 'mixto'" :class="formaPago !== 'efectivo' && formaPago !== 'mixto' ? 'bg-gray-100 text-gray-500 cursor-not-allowed' : 'bg-white'" class="block w-full rounded-xl border border-gray-300 px-4 py-3 text-gray-900" placeholder="0.00" />
                            @error('monto_recibido') <p class="mt-1 text-sm text-rose-600">{{ $message }}</p> @enderror
                        </div>
                        <div x-show="formaPago === 'efectivo' || formaPago === 'mixto'">
                            <label for="vuelto" class="mb-2 block text-sm font-medium text-gray-700">Vuelto <span x-show="formaPago === 'mixto'" class="text-xs text-gray-400">(efectivo)</span></label>
