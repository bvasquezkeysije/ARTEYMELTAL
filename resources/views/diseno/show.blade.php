<x-app-layout>
    ...
    <div x-data="{
        ...
        <div class="rounded-2xl border border-[#e5dec8] bg-white p-6 shadow-sm">
            ...
            <div class="mt-5">
                <p class="text-xs font-semibold uppercase tracking-wider text-amber-700">Archivos proporcionados por el cliente</p>
                <div class="mt-1">
            ...
            <div class="mt-4">
                <p class="text-xs font-semibold uppercase tracking-wider text-sky-700">Mis disenos (subidos por disenador)</p>
                <div class="mt-1">
