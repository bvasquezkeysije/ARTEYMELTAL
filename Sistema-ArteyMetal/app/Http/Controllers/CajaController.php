...
class CajaController extends Controller
{
    ...
    public function show(CajaApertura $cajaApertura)
    {
        ...
        $totalEfectivoVentas = $ventas->sum("monto_efectivo");
        $totalDigitalVentas = $ventas->sum("monto_digital");

        return view("cajas.show", compact("cajaApertura", "ventas", "totalEfectivoVentas", "totalDigitalVentas"));
    }
}
